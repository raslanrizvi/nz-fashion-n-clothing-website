                    ...
                    <div class="addPdtForm">
                        <form action="product_search2.php" method="post">
                                ...
                                <div class="col-auto my-1">
                                  <label class=" mr-sm-2" for="name">Search By</label>
                                    <select class="custom-select addPdtCtgryDrpDwn mr-sm-10" name="searchby" id="searchby">
                                        ...
                                        <option value="ptd_id">Product ID</option>
                                        <option value="title">Title</option>
                                        <option value="ctgy">Category</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" class="form-control addPdtTB" name="keyword" id="keyword" placeholder="Enter a keyword">
                                </div>
                            </div>
                            <div class="frmbtn">
