                    ...
                    <?php
                        ...
                        if($_REQUEST['status']=="pass"){
                           ...
                           <div class="alert alert-success pdtAddedAlert mb-3" role="alert">
                                <h4 class="alert-heading">Employee Deleted</h4>
                                <p>Employee Details has been successfully deleted from the database</p>
                                <hr>
                                <a href="delete_employee.php" class="addPdtbtn">Delete Another Employee</a>
                           ...
                           <?php
                            ...
                            <div class="alert alert-danger pdtAddedAlert" role="alert">
                                <h4 class="alert-heading">Error Deleting Employee</h4>
                                <p>An Error occurred While Deleting Employee Details, Please check and Try Again.</p>
                                <hr>
                                <a href="delete_employee.php" class="addPdtbtn">Try Again</a>
                                <a href="nz_admin_dashboard.php" class="homePdtbtn">Back To Home</a>
                            </div>
