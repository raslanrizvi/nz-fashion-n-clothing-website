...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="col-lg-12">
                        <nav class="mainMenu poppins">
                            ...
                            <ul>
                                ...
                                <li class="has-menu-items active"><a href="contact_us.php">Contact</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
        ...
        <section class="pageTitleSection pageTitleSection-contactus">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
