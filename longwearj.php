...
<html lang="en">
    <head>
        <title>NZ F&C | LongWear Jacket</title>
        <meta charset="UTF-8">
                            ...
                            <ul>
                                ...
                                <li class="has-menu-items active"><a href="shop.php">shop</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li><a class="active" href="longwearj.php">Longwear Jackets</a></li>
                    ...
                    <div class="col-lg-9 col-sm-8">
                        ...
                        <div class="row">
                            ...
                            <?php
                                ...
                                $sql = "SELECT * FROM product WHERE ctgy = 'LONGWEAR JACKET' ORDER BY RAND() LIMIT 12";
                        ...
                        <div class="row mtop32">
                            <div class="col-lg-12">
                                <div class="sop_navigation text-center">
                                    ...
                                    <a href="longwearj.php" class="next"><i class="flaticon-arrows-3"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <aside class="widget wow fadeInUp" data-wow-duration="700ms" data-wow-delay="450ms">
                            ...
                            <div class="widgetBody">
                                ...
                                <?php
                                        ...
                                        $sql2 = "SELECT * FROM product WHERE ctgy = 'LONGWEAR JACKET' AND  sale = 'on' ORDER BY RAND() LIMIT 3";
