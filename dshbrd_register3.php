                    ...
                    <?php
                        ...
                        if($_REQUEST['status']=="pass"){
                           ...
                           <div class="alert alert-success pdtAddedAlert" role="alert">
                                <h4 class="alert-heading">Employee Added</h4>
                                <p>New Employee has been successfully added.</p>
                                <hr>
                                <a href="dshbrd_register.php" class="addPdtbtn">Add Another Employee</a>
                           ...
                           <?php
                            ...
                            <div class="alert alert-danger pdtAddedAlert" role="alert">
                                ...
                                <p>A user already exists with the Username entered, Please check and Try Again or LogIn</p>
                                <hr>
                                <a href="dshbrd_login.php" class="addPdtbtn">Log In</a>
                                <a href="dshbrd_register.php" class="resetPdtbtn">Try Again</a>
                                <a href="nz_admin_dashboard.php" class="homePdtbtn">Back To Home</a>
                            </div>
                            ...
                            <div class="alert alert-danger pdtAddedAlert" role="alert">
                                <h4 class="alert-heading">Error Adding Employee</h4>
                                <p>An Error occurred While adding New Employee, Please check and Try Again.</p>
                                <hr>
                                <a href="dshbrd_register.php" class="addPdtbtn">Try Again Again</a>
                                <a href="nz_admin_dashboard.php" class="homePdtbtn">Back To Home</a>
                            </div>
