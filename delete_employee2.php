        ...
        <div class="row">
            <div class="box-register">
                ...
                <?php
                    ...
                    <form action="delete_employee3.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="inputBox-register " style="margin-left: auto; margin-right: auto;">
                            <input type="password" name="access_code" id="access_code" required="required" value="<?php echo $row['access_code'];?>">
                        ...
                        <button type="submit" class="enter-register">Delete</button>
                    ...
                    ?>
                            ...
                            <div class="alert alert-danger pdtAddedAlert" role="alert">
                                ...
                                <hr>
                                <a href="delete_employee.php" class="resetPdtbtn">Try Again</a>
